...
$(function() {
	...
	$(document).on('click',function(e) {
        $itemActions = $(".item-actions-dropdown");
		if (!$(e.target).closest('.item-actions-dropdown').length) {
			$itemActions.removeClass('active');
		}
	});
	
	$('body').on('click', '.item-actions-toggle-btn',function(e){
		e.preventDefault();
        $itemActions = $(".item-actions-dropdown");
    ...
    $('body').on('click', '.item-actions-list .edit',function(e){
        
		e.preventDefault();
        var self = $(this);
        self.closest('li').hide();
        self.closest('li').next('li').show();
        var parent = $(this).closest("div.item-row");
        $("div.item-row").not(parent).closest("li").find("div.results-area,div.edit-tournament-wrap").slideUp();
        parent.closest("li").find("div.results-area,div.edit-tournament-wrap").slideDown();

        
	});
    
     $('body').on('click', '.item-actions-list .trash',function(e){ 
         e.preventDefault();
     });

      $('body').on('click', '.item-actions-list .jqclose',function(e){
		e.preventDefault();
        var self = $(this);
        self.closest('li').hide();
        self.closest('li').prev('li').show();
        var parent = $(this).closest("div.item-row");      
        parent.closest("li").find("div.results-area,div.edit-tournament-wrap").slideUp();
	});
    ...
    // $('body').on('paste', ".date-input", function(){
    //     return false;
    // });
    ...
    $('body').on('keypress', 'input.jqdate-input', function() {return false;})
});
